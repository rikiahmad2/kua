        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?=base_url();?>Berita/submitTambah" method ="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="Nama">Kode Berita</label>
                    <input type="text" name="kode_berita" class="form-control" id="kode_berita" placeholder="Kode Berita" value="" readonly>
                  </div>
                  <div class="form-group">
                    <label for="JK">Nomor</label>
                    <input type="text" name="nomor" class="form-control" id="nomor" placeholder="Nomor Urut" value="">
                    </input>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" id="title" placeholder="Judul berita" value="">
                  </div>
                  <div class="form-group">
