        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?=base_url();?>Karyawan/submitEdit" method ="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="Nama">Kode Karyawan</label>
                    <input type="text" name="kode_karyawan" class="form-control" id="kode_karyawan" placeholder="Kode Karyawan" value="<?=$data['kode_karyawan']?>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="pend_terakhir" class="form-control" id="pend_terakhir" placeholder="Pendidikan Terakhir" value="<?=$data['pend_terakhir']?>">
                  </div>
