        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?=base_url();?>Admin/submitSettings" method ="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama User</label>
                    <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama User" value="">
                  </div>
                  <div class="form-group">
...
<script type="text/javascript">
  function myFunction(){
    alert("Perubahan Diterima, Silahkan Login Kembali !");
  }
</script>
<!-- overlayScrollbars -->
